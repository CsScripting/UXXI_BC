...
import PackManageData.main_manage_data_planning_uxxi as managDataPlan
...
def exe_process_steps (gl_check_main_process, gl_opcion_process_to_ejecute : int, gl_name_file_uxxi: str,
                       gl_name_process_to_import : str, gl_event_type_process : str, gl_date_last_update : str, 
                       gl_check_opcion_process : int, gl_opcion_conector : int):

    valid_process = False

    # OPCIONES MAIN PROCESS:
